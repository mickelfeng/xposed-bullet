...
import com.sky.xposed.bullet.hook.HookManager;
...
public class Main implements IXposedHookLoadPackage, MethodHook.ThrowableCallback {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        ...
        if (Constant.Smile.PACKAGE_NAME.equals(packageName)) {
            // 初始化
            hookSmileApplication(lpparam);
        }
    }

    private void hookSmileApplication(final XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        XposedPlus.get()
                .findMethod("com.stub.StubApp", "onCreate")
